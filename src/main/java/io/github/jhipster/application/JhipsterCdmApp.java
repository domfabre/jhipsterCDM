...
public class JhipsterCdmApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterCdmApp.class);

    private final Environment env;

    public JhipsterCdmApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterCDM.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterCdmApp.class);
